...
== Summary
Congratulations! You've just developed a simple publish-and-subscribe application with Spring and RabbitMQ. There's https://docs.spring.io/spring-amqp/reference/#_introduction[more you can do with Spring and RabbitMQ] than what is covered here, but this should provide a good start.
